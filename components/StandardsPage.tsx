      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-12">
          {MINIMUM_STANDARDS.map(s => (
            <div key={s.id} className="relative p-6 md:p-10 border border-black/5 bg-white hover:border-black transition-all group overflow-hidden rounded-sm">
              ...
              <div className="relative z-10">
                ...
                <div className="absolute top-0 right-0 text-4xl font-heading font-black text-slate-50 group-hover:text-red/5 transition-colors select-none">
                  {s.id}
                </div>
              </div>
            </div>
