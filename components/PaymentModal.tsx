          ...
          <div className="space-y-8">
            <div className="bg-white border border-black p-8 flex items-center justify-between shadow-lg">
                <div className="flex items-center gap-6">
                    <span className="text-lg font-black uppercase tracking-widest italic text-red">Mandatory Verification</span>
                </div>
            ...
            >
              {loading ? (
                ...
                `Finalize €${plan.price} Payment`
              )}
            </button>

            <div className="flex flex-col items-center gap-6 pt-6">
                <p className="text-[10px] text-center text-slate-300 font-black uppercase tracking-[0.4em]">
                    Brands <span className="text-red">MUST</span> provide valid corporate details.
                </p>
            </div>
          </div>
        </div>
